...
(function ($) {
    ...
    $(document).on('click', '.addToCompare', function () {
        ...
        if (inArray < 0) {
            ...
            if (list.length < 3) {
                ...
                $(".comparePan").append('<div id="' + productID + '" class="relPos titleMargin w3-margin-bottom   w3-col l3 m4 s4"><div class="w3-white titleMargin"><a class="selectedItemCloseBtn w3-closebtn cursor">&times</a><img class="center-block" src="' + image + '" alt="image" style="height:100px;"/><br><p class="text-center" id="' + productID + '" class="titleMargin1">' + displayTitle + '</p></div></div>');
    ...
    $(document).on('click', '.cmprBtn', function () {
        ...
        if ($(".cmprBtn").hasClass("active")) {
            ...
            $(".contentPop").append('<div class="w3-col s3 m3 l3 compareItemParent relPos">' + '<ul class="product">' + '<li class=" relPos compHeader"><p class="w3-display-middle">Features</p></li>' + '<li>Title</li>' + '<li>Size</li>' + '<li>Weight</li>' + '<li class="cpu">Processor</li>' + '<li>Battery</li>' + '<li>Price</li></ul>' + '</div>');
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                $(".contentPop").append('<div class="w3-col s3 m3 l3 compareItemParent relPos">' + '<ul class="product">' + '<li class="compHeader"><img src="' + image + '" class="compareThumb"></li>' + '<li>' + title + '</li>' + '<li>' + $(product).data('size') + '</li>' + '<li>' + $(product).data('weight') + '<li class="cpu">' + $(product).data('processor') + '</li>' + '<li>' + $(product).data('battery') + '</li>' + '<li>' + $(product).data('price') + '</li></ul>' + '</div>');
